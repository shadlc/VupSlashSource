...
local t = {
	...
	["peach"] = "桃",
	[":peach"] = "基本牌<br /><b>时机</b>：出牌阶段/当一名角色处于濒危状态时<br /><b>目标</b>：已受伤的你/一名处于濒危状态的角色<br /><b>效果</b>：目标角色回复1点体力。",
	...
	["qinggang_sword"] = "青釭剑",
	[":qinggang_sword"] = "装备牌·武器<br /><b>攻击范围</b>：２<br /><b>武器技能</b>：锁定技，你使用【杀】指定目标后，你无视目标角色的防具直到此【杀】第一次对其生效后。",

	["blade"] = "青龙偃月刀",
	[":blade"] = "装备牌·武器<br /><b>攻击范围</b>：３<br /><b>武器技能</b>：当你使用的【杀】被目标角色使用的【闪】抵消时，你可以对其使用一张【杀】。（无距离限制）",
	...
	["halberd"] = "方天画戟",
	[":halberd"] = "装备牌·武器<br /><b>攻击范围</b>：４<br /><b>武器技能</b>：若你使用的【杀】是你最后的手牌，此【杀】的可指定目标数＋2。",

	["kylin_bow"] = "麒麟弓",
	[":kylin_bow"] = "装备牌·武器<br /><b>攻击范围</b>：５<br /><b>武器技能</b>：当你使用【杀】对目标角色造成伤害时，你可以破坏其装备区内的一张坐骑牌。",
	...
	["ice_sword"] = "寒冰剑",
	[":ice_sword"] = "装备牌·武器<br /><b>攻击范围</b>：２<br /><b>武器技能</b>：锁定技，你使用【杀】对目标角色造成的伤害视为冰霜伤害。",
	["ice_sword:yes"] = "你可以依次破坏其两张牌",

	["horse"] = "坐骑",
	[":+1 horse"] = "装备牌·坐骑<br /><b>坐骑技能</b>：其他角色→你 距离＋1。",
	["jueying"] = "绝影",
	["dilu"] = "的卢",
	["zhuahuangfeidian"] = "爪黄飞电",
	[":-1 horse"] = "装备牌·坐骑<br /><b>坐骑技能</b>：你→其他角色 距离－1。",
	["chitu"] = "赤兔",
	["dayuan"] = "大宛",
	["zixing"] = "紫骍",
	...
	["collateral"] = "借刀杀人",
	[":collateral"] = "锦囊牌<br /><b>时机</b>：出牌阶段<br /><b>目标</b>：一名装备区内有武器牌且攻击范围内有其使用【杀】的合法目标的其他角色。<br/><font color='#DC143C'>此牌的目标数不能大于1。</font><br /><b>执行动作</b>：选择目标攻击范围内的一个合法目标。<br /><b>效果</b>：目标需对你为其选择的合法目标使用【杀】，否则你获得其装备区内的武器牌。",
	...
	["snatch"] = "顺手牵羊",
	[":snatch"] = "锦囊牌<br /><b>时机</b>：出牌阶段<br /><b>目标</b>：距离为1 的一名区域内有牌的其他角色<br /><b>效果</b>：获得目标角色的区域内的一张牌。",

	["dismantlement"] = "过河拆桥",
	[":dismantlement"] = "锦囊牌<br /><b>时机</b>：出牌阶段<br /><b>目标</b>：一名区域内有牌的其他角色<br /><b>效果</b>：破坏目标角色区域内的一张牌。",
	...
	["wooden_ox"] = "木牛流马",
	[":wooden_ox"] = "装备牌·宝物<br /><b>宝物技能</b>：<br />出牌阶段限一次，你可以将一张手牌移出游戏并扣置于此牌下，若如此做，你可以将装备区内的此牌置入一名其他角色的装备区；你可以将此装备牌下的牌如手牌般使用或打出。",
