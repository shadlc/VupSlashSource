...
sgs.ai_playerchosen_intention.sp_moonspear = 10

function sgs.ai_weapon_value.sp_moonspear(self, enemy, player)
	if player:hasSkills("xingyi|yunyao|yueying|yuechao|guanxi") then
		return 4
	end
end
