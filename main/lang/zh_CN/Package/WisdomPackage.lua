...
local t = {
	...
	["beifa"] = "努力家",
        --[":beifa"] = "锁定技，你失去最后的手牌时，你视为对一名其他角色使用一张【杀】，否则视为对自己使用一张【杀】。",
        [":beifa"] = "锁定技，你失去最后的手牌时，你视为对一名其他角色使用一张【杀】。",
	...
	["weidai"] = "危殆",
        [":weidai"] = "主公技，当你需要使用一张【酒】时，你可以令其他吴势力角色将一张黑桃2~9的手牌置入弃牌堆，视为你将该牌当【酒】使用。",
