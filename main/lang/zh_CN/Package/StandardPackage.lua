...
local t = {
	...
	["collateral"] = "借刀杀人",
	[":collateral"] = "锦囊牌<br /><b>时机</b>：出牌阶段<br /><b>目标</b>：一名装备区里有武器牌且攻击范围内有其使用【杀】的合法目标的其他角色。<br/><font color='#DC143C'>此牌的目标数不能大于1。</font><br /><b>执行动作</b>：选择目标攻击范围内的一个合法目标。<br /><b>效果</b>：目标需对你为其选择的合法目标使用【杀】，否则你获得其装备区内的武器牌。",
